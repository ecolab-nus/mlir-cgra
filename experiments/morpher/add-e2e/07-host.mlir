...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "i386-unknown-linux-gnu", soda.container_module} {
  func.func private @cgra_generic_0(memref<256xf32>, memref<256xf32>, memref<256xf32>)
  func.func @main_graph(%arg0: memref<1024xf32>) {
    ...
    scf.for %arg1 = %c0 to %c1024 step %c256 {
      %4 = memref.subview %1[%arg1] [256] [1] : memref<1024xf32> to memref<256xf32, #map>
      %5 = memref.subview %2[%arg1] [256] [1] : memref<1024xf32> to memref<256xf32, #map>
      %6 = memref.subview %3[%arg1] [256] [1] : memref<1024xf32> to memref<256xf32, #map>
      ...
      memref.copy %4, %8 : memref<256xf32, #map> to memref<256xf32>
      memref.copy %5, %10 : memref<256xf32, #map> to memref<256xf32>
      memref.copy %6, %12 : memref<256xf32, #map> to memref<256xf32>
      func.call @cgra_generic_0(%8, %10, %12) {__morpher_kernel__} : (memref<256xf32>, memref<256xf32>, memref<256xf32>) -> ()
      memref.copy %12, %6 : memref<256xf32> to memref<256xf32, #map>
