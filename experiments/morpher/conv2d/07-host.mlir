...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "i386-unknown-linux-gnu", soda.container_module} {
  func.func private @cgra_generic_0(memref<1x4x4x1xf32>, memref<8x3x3x1xf32>, memref<1x2x2x8xf32>)
  ...
  func.func @cgra_kernel(%arg0: memref<1x6x6x1xf32, #map0>) -> memref<1x4x4x8xf32> {
    ...
    scf.for %arg1 = %c0 to %c4 step %c2 {
      scf.for %arg2 = %c0 to %c4 step %c2 {
        ...
        func.call @cgra_generic_0(%7, %0, %10) {__morpher_kernel__} : (memref<1x4x4x1xf32>, memref<8x3x3x1xf32>, memref<1x2x2x8xf32>) -> ()
