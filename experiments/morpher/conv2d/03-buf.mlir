  ...
  func.func @cgra_kernel(%arg0: memref<1x6x6x1xf32, #map0>) -> memref<1x4x4x8xf32> {
    ...
    scf.for %arg1 = %c0 to %c4 step %c2 {
      scf.for %arg2 = %c0 to %c4 step %c2 {
        ...
        linalg.conv_2d_nhwc_fhwc ins(%4, %0 : memref<1x?x?x1xf32, #map0>, memref<8x3x3x1xf32>) outs(%5 : memref<1x2x2x8xf32, #map2>)
        %6 = memref.subview %1[0, %arg1, %arg2, 0] [1, 2, 2, 8] [1, 1, 1, 1] : memref<1x4x4x8xf32> to memref<1x2x2x8xf32, #map2>
        memref.copy %5, %6 : memref<1x2x2x8xf32, #map2> to memref<1x2x2x8xf32, #map2>
      }
    }
