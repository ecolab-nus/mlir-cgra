...
# MORPHER_PATH=/home/huiying/workspace/Morpher/Morpher_DFG_Generator/build/
...
# soda-opt -lower-all-to-llvm="use-bare-ptr-memref-call-conv=true" accel-for.mlir > accel-bare.mlir
